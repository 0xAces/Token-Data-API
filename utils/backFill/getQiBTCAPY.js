...
const getQiBTCAPY = async (web3s, blockNum, timestamp) => {
    ...
    const totalAPY = (supplyAPY + totalSupplyDistributionAPY) * (1 - fees.qiBTC)
    APYData.APY.description = "qiBTC Supply + Distribution APY"
