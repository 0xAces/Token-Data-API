...
const getQiUSDTnAPY = async (web3s, blockNum, timestamp) => {
    ...
    let qiToken = new avax_web3.eth.Contract(qiTokenAbi, avax_addresses.qiUSDTn)
    ...
    const totalAPY = (supplyAPY + totalSupplyDistributionAPY) * (1 - fees.qiUSDTn)
    APYData.APY.description = "qiUSDTn Supply + Distribution APY"
