...
const getQiAVAXAPY = async (web3s, blockNum, timestamp) => {
    ...
    let qiToken = new avax_web3.eth.Contract(qiTokenAbi, avax_addresses.qiAVAX)
    ...
    const totalAPY = (supplyAPY + totalSupplyDistributionAPY) * (1 - fees.qiAVAX)
