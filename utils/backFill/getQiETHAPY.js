...
const getQiETHAPY = async (web3s, blockNum, timestamp) => {
    ...
    let qiToken = new avax_web3.eth.Contract(qiTokenAbi, avax_addresses.qiETH)
    ...
    const totalAPY = (supplyAPY + totalSupplyDistributionAPY) * (1 - fees.qiETH)
    APYData.APY.description = "qiETH Supply + Distribution APY"
