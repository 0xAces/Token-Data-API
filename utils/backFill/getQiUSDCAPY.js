...
const getQiUSDCAPY = async (web3s, blockNum, timestamp) => {
    ...
    const totalAPY = (supplyAPY + totalSupplyDistributionAPY) * (1 - fees.qiUSDC)
    APYData.APY.description = "qiUSDC Supply + Distribution APY"
