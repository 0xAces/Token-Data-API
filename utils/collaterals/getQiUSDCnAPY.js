...
const getQiUSDCnAPR = async (web3s) => {
    ...
    let qiToken = new avax_web3.eth.Contract(qiTokenAbi, avax_addresses.qiUSDCn)
    ...
    APRData.APR.description = "qiUSDCn Supply + Distribution APY"
